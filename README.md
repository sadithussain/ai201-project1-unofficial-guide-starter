...
|---|----------|-----------------|------------------------------|-------------------|-------------------|
| 1 | How strict are Maria Cepeda's deadline policies? | She is very strict about these policies and there are almost always no extensions. | Detailed her "insane missed exam policy", but noted assignment due dates are clear and more reasonable. | Relevant | Accurate |
